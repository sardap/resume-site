...
const yearsProgramming = Math.floor(
  moment.duration(moment(new Date()).diff(moment('2016', 'YYYY'))).asYears() - 1
)
...
const workHistories: WorkHistory[] = [
  ...
  },
  {
    ...
    links: [
      {
        name: 'Blockchain versus database: a critical analysis cites' + ' (cites 40)',
      ...
      {
        name:
          'Blockchain for fraud prevention: a work-history fraud' + ' prevention system (cites 18)',
        link: 'https://ieeexplore.ieee.org/abstract/document/8456149/'
      },
      {
        name: 'Continuous authorization in Subject-Driven data sharing' + ' Using Wearable Devices',
...
<template>
  ...
  <div class="about-me">
    <ul class="about-ul">
      ...
      <li>Awarded Bachelor of Computer Science from Swinburne University in 2019.</li>
      <li>Have been programming for {{ yearsProgramming }} Years</li>
      <li>Programming professionally for {{ yearsProfProgramming }} Years</li>
      <li>
      ...
      <li>
        Constantly work on
        <router-link to="/personal-projects">personal projects</router-link> some you see in this
        browser!
      </li>
    </ul>
  </div>
  ...
  <div v-for="work in workHistories" :key="work.company">
    <h3>
    ...
    <div v-if="work.links.length > 0">
      <ul class="about-ul">
        <li v-for="link in work.links" :key="link.link">
