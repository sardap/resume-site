      ...
      <div class="workexp">
        ...
        <div class="date">
          ...
          <p>
            {{
              row.endDate
                ? `${row.endDate.year()}-${`${row.endDate.month() +
                    1}`.padStart(2, "0")}`
                : "current"
            }}
          </p>
        ...
        <p class="responsibilities">{{ row.responsibilities }}</p>
        <ul class="links" v-if="row.links !== null">
          <li v-for="(link, jndex) in row.links" :key="jndex">
