...
<template>
    <div>
        ...
        <div>
            ...
            <p v-else-if="barks < 25">You will never find out because i'm not sure what the secret is ({{ barks }})</p>
            <p v-else>{{ barks }} That was another lie the endless barking has woken me up before <a
                    href="https://www.youtube.com/watch?v=Z43UBOW7NiQ&list=FLQ6znzvz_EIoXXY9FT1XJkA"
                    target="_blank">steamtember hams</a> {{ barks }}
            </p>
        </div>
    </div>
</template>
