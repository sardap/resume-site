...
const questions: Question[] = [
    ...
    {
        question: "Which Australian Prime Minister had the highest Nielsen Poll rating at any point during their tenure?",
        options: [
            "Kevin Rudd",
            "John Howard",
            "Bob Hawke",
    ...
    {
        question: "Which of these options is the correct order of release for these consoles in Australia?",
        options: [
        ...
        bonusInfo: "The Sega Saturn was released in 1995, followed by the Playstation 1 later the same year, and the Nintendo 64 in 1997."
    },
    {
    ...
    {
        question: "Which Attorney General quashed a workers' strike in 1938 that protested the export of iron to Japan following the Nanking Massacre?",
        options: [
    ...
    {
        question: "What did King Charles III write to Governor General John Kerr after he dismissed the democratically elected Prime Minister, Gough Whitlam?",
        options: [
    ...
    {
        question: "Which government agency conducted a 1983 training operation at the Sheraton Hotel, during which its employees brandished firearms at hotel staff and guests during a mock hostage scenario without prior notification to the police or hotel management?",
        options: [
    ...
    {
        question: "Which political party deliberately designed misleading signs in Chinese, resembling those of the Australian Electoral Commission (AEC), to deceive voters into voting for them?",
        options: [
            "Liberal Party",
        ...
        bonusInfo: "The signs stated 'the correct way to vote' and instructed electors to put a '1' next to the Liberal candidate's name."
    },
    {
        question: "Which mining company knowingly destroyed a 46,000-year-old Aboriginal cave system in 2019?",
        options: [
            "Rio Tinto",
            "BHP",
        ...
        answer: "Rio Tinto",
        bonusInfo: "The investigation concluded that 'Rio Tinto knew the value of what they were destroying but blew it up anyway.'"
    },
    {
    ...
    {
        question: "According to Korean age, if someone was born on 30th December 1999, how old would they be on 1st January 2000?",
        answer: "2",
    },
    {
        ...
        answer: "Dolphin",
        bonusInfo: "The GameCube's graphics chip was named 'Flipper' in reference to the 'Dolphin' codename."
    },
    {
    ...
    {
        question: "Which company sued the developers, Silicon Knights, accusing them of stealing their source code to create the engine for the hit Xbox 360 game Too Human?",
        options: [
            "Epic Games",
            "ZeniMax Media",
            "Id Software",
    ...
    {
        question: "How many pit bulls did the police seize from DMX's house when they raided it in 2008 due to a dog-fighting ring?",
        answer: "12",
    },
    {
...
function getScore() {
    ...
    return `${correct}/${questionHistory.value.length} (${Math.round((correct / questionHistory.value.length) * 100)}%)`;
}
    ...
    <div class="question">
                ...
                <div v-if="currentQuestion.options" class="table-container">
                    <table>
                        <tr v-for="(option, i) in currentQuestion.options">
                            <td><input :id="`quiz_time_radio_${i}`" :name="`quiz_time_radio_${i}`" type="radio"
                                    :value="option" v-model="answer" /></td>
                            <td><label :id="`quiz_time_radio_${i}`" :for="`quiz_time_radio_${i}`">{{ option }}</label></td>
                        </tr>
                    </table>
                </div>
                <div v-else>
        ...
        <div v-if="questionHistory.length > 0">
            ...
            <table class="answer-table">
                ...
                <tr v-for="(question, i) in questionHistory" class="border_bottom"
