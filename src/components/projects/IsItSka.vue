...
<template>
  <ProjectInfo :filter="filter" :good="true" :languages="complete?.langs" :technologies="techs">
    ...
    <p>
      ...
      <b>MACHINE LEARNING</b> to attempt to classify weather or not a song is ska. This is done
      <a :href="featuresDocLink">by getting each songs features using the Spotify web API.</a>
      Followed by training a classifier by using a list of ska and not ska tracks. With the machine
      learning features being the above mentioned song features from the Spotify API. This works
      pretty badly. I have found a RandomForest classifier is working best.
    </p>
    <br />
